...
lv11 = [[5, 6], [6, 5]] # 0-1
lv12 = [[5, 0], [5, 1], [5, 2], [6, 0], [6, 1], [6, 2]]  # 2-7
lv13 = [[5, 3], [5, 4], [6, 3], [6, 4]] # 8-11
lv22 = [[0, 1], [0, 2], [1, 0], [1, 2], [2, 0], [2, 1]] # 12-17
lv23 = [[0, 3], [0, 4], [1, 3], [1, 4], [2, 3], [2, 4]] # 18-23
lv33 = [[3, 4], [4, 3]] # 24-25

lv31 = [[3, 5], [3, 6], [4, 5], [4, 6]] # 26-29
lv32 = [[3, 0], [3, 1], [3, 2], [4, 0], [4, 1], [4, 2]] # 30-35
lv21 = [[0, 5], [0, 6], [1, 5], [1, 6], [2, 5], [2, 6]] # 36-41

SEQ = lv11 + lv12 + lv13 + lv22 + lv23 + lv33 + lv31 + lv32 + lv21
