...
from diffusion_policy.policy.goal_condition.kitchen_cond import KitchenCondition
class DiffusionTransformerLowdimCondPolicy(BaseLowdimPolicy):
    def __init__(self, 
        ...
        if condition is not None:
            print("============= using external condition =============")
            cond_env = condition['cond_env']
            cond_method = condition['cond_method']
            ...
            elif cond_env == 'kitchen':
                self.external_condition = KitchenCondition(cond_method)
    ...
    def compute_loss(self, batch):
        ...
        if self.obs_as_cond:
            ...
            # ============  external condition ============
            new_cond = self.external_condition.get_train_condition(action, obs, cond)
            cond = new_cond
